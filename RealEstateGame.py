# Author: Jenna Brannan
# GitHub username: jennabrannan
# Date: 05/23/2022
# Description: This program allows two or more players to play a simplified version of Monopoly called the
